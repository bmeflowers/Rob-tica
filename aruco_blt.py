...
# -*- coding: utf-8 -*-
"""
Robot Seguidor de Códigos ArUco - VERSIÓN FINAL CORREGIDA
...
VELOCIDAD_ENVIO = 1.5           # Segundos entre comandos (KEEPALIVE)
...
class RobotArucoTracker:
    ...
    def verificar_conexion_bluetooth(self):
        ...
        if not os.path.exists(BLUETOOTH_PORT):
            ...
            print()
            print("SOLUCION:")
            print("1. Verifica que el script de Bluetooth este corriendo")
            print("2. Ejecuta el script de conexion primero")
            print()
            return False
    ...
    def conectar_bluetooth(self):
        ...
        try:
            ...
            print("Verifica que el script de Bluetooth este corriendo")
            return False
    ...
    def enviar_comando(self, comando):
        """Envía un comando al Arduino - CON KEEPALIVE"""
        try:
            tiempo_actual = time.time()
            
            # KEEPALIVE: Enviar aunque sea el mismo comando después de VELOCIDAD_ENVIO
    ...
    def calcular_comando(self, distancia, yaw):
        ...
        # En posición objetivo -> Detener
            ...
            return CMD_DETENER, f"Posicion OK ({distancia:.1f}cm)", (0, 255, 0)
    ...
    def ejecutar(self):
        ...
        print(f"  Tolerancia angular: +/-{ANGULO_YAW_TOLERANCIA} grados")
        ...
        try:
            while True:
                ...
                # Enviar comando (KEEPALIVE activo)
...
def main():
    print("\n" + "=" * 60)
    print("  ROBOT SEGUIDOR DE ARUCO CON DISTANCIA Y ROTACION")
    print("  Raspberry Pi 4 + Arduino + HC-05 + Deteccion 3D")
    print("  CON KEEPALIVE ACTIVO")
    print("=" * 60 + "\n")
